...
namespace gl::enums {
    enum class general : gl::enum_ {
        ...
        DIM_2 = GL_2D,
        DIM_3 = GL_3D,
        DIM_3_COLOR = GL_3D_COLOR,
        DIM_3_COLOR_TEXTURE = GL_3D_COLOR_TEXTURE,
        DIM_4_COLOR_TEXTURE = GL_4D_COLOR_TEXTURE,
        ...
        FLOAT = GL_FLOAT,
        COUNT_2_BYTES = GL_2_BYTES,
        COUNT_3_BYTES = GL_3_BYTES,
        COUNT_4_BYTES = GL_4_BYTES,
        DOUBLE = GL_DOUBLE,
        CLEAR = GL_CLEAR,
        AND = GL_AND,
